...
本 Skill 的财务部分服务于公司整体画像，不重建标准化三表，不展开完整比率体系、科目底稿、预测模型或公式 Excel。需要深入财务且当前环境有 `hehe-financial-analysis` 时，由其完成深算，本 Skill 只吸收与公司画像有关的核心结论；未调用该 Skill 时，仍自行完成上述基础财务画像。
